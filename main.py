...
QR_DATA_URL = os.getenv('QR_DATA_URL', 'https://github.com/Saideepak9676')  
...
def main():
    ...
    parser.add_argument('--url', help='The URL to encode in the QR code', default=QR_DATA_URL)
    args = parser.parse_args()

    setup_logging()
    
    timestamp = datetime.now().strftime('%Y%m%d%H%M%S')
    qr_filename = os.getenv('QR_CODE_FILENAME', f"QRCode_{timestamp}.png")
